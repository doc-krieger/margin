export type MarkdownBlockType = "doc" | "paragraph" | "heading" | "blockquote" | "bulletList" | "orderedList" | "listItem" | "table" | "tableRow" | "tableCell" | "tableHeader";
...
export interface UnsupportedFeature {
    code: "fenced-code" | "indented-code" | "raw-html" | "image" | "reference-definition" | "footnote" | "task-list" | "thematic-break" | "setext-heading" | "strike-through" | "inline-code" | "hard-break" | "unsupported-heading" | "unsupported-list" | "unsupported-link" | "malformed-table" | "parse-error";
    message: string;
    line?: number;
}
